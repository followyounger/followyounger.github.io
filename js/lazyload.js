...
;(function(factory){
    ...
    var w = window,
        ...
        defaultOptions = {
            ...
            placeholder_real_img        : 'https://soptq.me/img/icon/placeholder.jpg'
    ...
    if(!$.fn.hasOwnProperty('lazyload')){
        ...
        $.fn.lazyload = function(options){
            ...
            $elements.each(function(i,e){
                ...
                // If element is an img and no src attribute given and isn't in post-container, use placeholder.
                if(isImg && !placeholderSrc && $element.attr('data-skip-fake') !== "true"){
